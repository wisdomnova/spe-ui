-- Lightweight counts for GET /api/elections (single RPC, GROUP BY).
-- Applied via: supabase db query --linked -f supabase/migrations/20260216140000_get_election_list_counts.sql
